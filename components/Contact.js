    ...
    <div className="text-center">
      ...
      <div className="mb-20 md:mb-32 border-l-8 border-[#A31F34] pl-8">
        ...
        <a
          ...
          className="inline-block text-lg md:text-5xl font-black text-black border-b-4 border-[#A31F34] pb-3 md:pb-5 hover:text-[#A31F34] transition-all duration-500 ease-in-out tracking-tight break-all uppercase"
        >
      ...
      <div className="border-l-8 border-[#A31F34] pl-8">
        ...
        <div className="flex justify-center gap-12 md:gap-16 flex-wrap items-center">
          <a
            ...
            className="text-[#A31F34] hover:text-black transition-all duration-500 ease-in-out border-4 border-[#A31F34] p-3 hover:border-black hover:shadow-lg"
            aria-label="GitHub"
          >
            <FaGithub size={56} />
          </a>
