  ...
  return (
    <div>
      ...
      <div className="grid gap-12 md:grid-cols-2">
        <div>
          <h2 className="text-4xl font-serif font-light mb-6 text-gray-900">About</h2>
          <div className="space-y-6 text-lg font-serif text-gray-700 leading-relaxed">
            <p>
        ...
        <div className="border-l-2 border-gray-300 pl-8">
          <h3 className="font-serif font-light text-2xl mb-6 text-gray-900">Education</h3>
          <p className="text-lg font-serif text-gray-700 leading-relaxed mb-3"><strong className="text-blue-600">BS Computer Science</strong>, 3rd Year</p>
          <p className="text-base font-serif text-gray-500 mt-3">Davao, Philippines</p>
        </div>
      </div>
    </div>
  );
